...
class DatabaseManager:
    ...
    def insert_transformed_event(self, transformed_event: Dict[str, Any]) -> None:
        ...
        try:
            ...
            logger.error(f"Failed to insert transformed event {transformed_event.get('event_id')}: {e}")
            raise
    ...
    def insert_ai_request(self, event: Dict[str, Any]) -> str:
        ...
        try:
            ...
            logger.error(f"Failed to insert AI request for event {event.get('event_id')}: {e}")
            raise
    ...
    def update_ai_request_status(self, request_id: str, status: str, 
                                answer: str = None, error_message: str = None, 
    ...
    def get_ai_request_by_id(self, request_id: str) -> Optional[Dict[str, Any]]:
    ...
    def get_ai_requests_by_user(self, user_id: int, limit: int = 50) -> List[Dict[str, Any]]:
...
class DataTransformer:
    ...
    def transform_event(event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        revenue = 0.0
        if event['event_type'] == 'purchase' and 'amount' in event.get('properties', {}):
